               ...
               tabItem(tabName = "home",
                       ...
                       tabsetPanel(
                         ...
                         tabPanel("Conclusion",
                                  ...
                                  p(strong("Brock Purdy's metrics not only indicate that his skill is within or above that of the highest paid quarterbacks in the NFL, he consistently outperforms Kyle Shanahan's other quarterbacks and is a consistent player under pressure. While Purdy does benefit significantly from the running game, and does not outperform his predicted average benchmarks, Brock Purdy's overall performance is outstanding and warrants a market-rate salary."))
                         )
                       )
