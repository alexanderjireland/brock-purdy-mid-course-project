...
# Conclusion
This app aims to give insight into Brock Purdy's true skill apart from the elite support surrounding him. This is, of course, a quite challenging thing to do. To approach this question, we examine the aforementioned quarterback metrics for Brock Purdy in high-pressure situations and heavy vs. light rushing games. In addition, we created models for each metric designed to predict a quarterback's EPA, ANY/A, or Passer Rating depending on the following variables: Yards After the Catch (YAC), Percentage of Passing Yards from YAC, Sacks per Dropback, Short Pass Attempts, Percentage of Short Passes, and Total Rushing Yards. An elite quarterback would be thought to outperform their predicted metric, on average. Finally, we compare Purdy to other quarterbacks coached by Kyle Shanahan to see how Shanahan's offensive playmaking factors into Purdy's metrics. We also compare Purd7 to the top ten highest paid quarterbacks (as of 2024), to evaluate where he compares to these play-makers.

**Brock Purdy's metrics not only indicate that his skill is within or above that of the highest paid quarterbacks in the NFL, he consistently outperforms Kyle Shanahan's other quarterbacks and is a consistent player under pressure. While Purdy does benefit significantly from the running game, and does not outperform his predicted average benchmarks, Brock Purdy's overall performance is outstanding and warrants a market-rate salary.**
